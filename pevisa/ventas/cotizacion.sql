-- cotizacion
select c.serie, c.num_ped, c.fecha, c.cod_cliente, e.nombre, c.cond_pag
     , c.cod_vende, v.nombre as nom_vendedor, c.refe_pedido, p.estado
     , c.moneda, c.total_bruto, c.total_descuento, c.total_igv, c.total_valvta
