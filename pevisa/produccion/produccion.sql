select *
 ...
 where nuot_tipoot_codigo = 'PR'
   and numero in (
                  543103, 554695, 554766, 566640, 569858, 571033, 571266, 575737, 575810, 580070,
                  580072, 580249, 580521, 581250, 581251, 581563, 581844, 582283, 582691, 582692,
                  583047, 583117, 583388, 584079, 584746
   );
