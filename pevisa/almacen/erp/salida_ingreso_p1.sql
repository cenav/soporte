declare
  ...
  k_tpo constant kardex_g.tp_transac%type    := '27';
...
begin
  ...
  insert into kardex_g
    ...
    , numero_1, numero_2)
  values
    ( k_alm, k_tpo, k_ser, l_nro, k_fch, null, null, null, null, null, null, null, null, null
  ...
  for r in (select cod_art, cantidad from tmp_carga_data) loop
    ...
    values
      ( k_alm, k_tpo, k_ser, l_nro, r.cod_art, r.cantidad, 0.000000, 0.000000
